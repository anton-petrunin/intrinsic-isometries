...
\parit{Proof.}
Stat with a metric graph\footnote{That is, locally finite graph with length metric, such that each edge is isometric to a real interval.} $\Gamma$;
...
For each $n$, chose a $\eps_n$-dense set of \emph{vertexes} in $\JJ_n$.
